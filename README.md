...
You can configure the run length and more for the full random runs using the [DreamDiveTweaks](https://thunderstore.io/c/hades-ii/p/zerp/DreamDiveTweaks/) ImGui menu.
